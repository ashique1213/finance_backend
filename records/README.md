...
A robust backend system for a Finance Dashboard built with **Django REST Framework**. The system supports role-based access control, financial record management, and dashboard analytics with **PostgreSQL (Neon)** as the database.
